...
# Export Route-F.1 (recentering-biased) probabilistic encoder trajectories
# to GHNN/DEL-compatible HDF5 files using eval_bounding_boxes.py.
...
PROB_ENCODER_CHECKPOINT="${CHECKPOINT}/oracle/f1/prob_encoder_best.pth"
DEVICE="cuda:0"
BATCH_SIZE=32
GHNN_OUTPUT_DIR="${CHECKPOINT}/oracle/extracted_datasets"
GHNN_DATASET_NAME="prob_encoder_f1"
...
echo "============================================================"
echo "  Exporting probabilistic encoder dataset: Route F.1"
...
echo ""
echo "============================================================"
echo "  Route F.1 export complete."
